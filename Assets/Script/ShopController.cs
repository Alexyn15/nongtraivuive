...
public class ShopController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            CurrencyController.Instance.OnGlodChanged += UpdateMoneyDisplay;
    ...
    private void CreateShopSlot(Transform grid, int itemID, int quantity, bool isShop, Slot originalSlot = null)
    {
        ...
        //ItemHanðler
        ItemDragHandler dragHandeler = itemInstance.GetComponent<ItemDragHandler>();
        if (dragHandeler) dragHandeler.enabled = false;
